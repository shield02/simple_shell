...
/**
 * _myexit - This will exits the shell
 * @info: This is the Structure containing potential arguments. Used to maintain
 * constant function prototype.
 * Return: This will exits with a given exit status
...
/**
 * _myhelp - this will changes the current directory of the process
 * @info: this will Structure containing potential arguments. Used to maintain
 * constant function prototype.
 * Return: Always 0
 */
